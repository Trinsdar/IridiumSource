...
public class Config {
    ...
    public static int netherGenChance = 10;
    public static int endGenChance= 15;
    public static int overworldGenChance = 10;
    ...
    private static void initGeneralConfig(Configuration cfg) {
        ...
        netherGenChance = cfg.getInt("netherGenChance", CATEGORY_GENERAL, netherGenChance, 0, 300, "Set this to whatever value you want");
        endGenChance = cfg.getInt("endGenChance", CATEGORY_GENERAL, endGenChance, 0, 300, "Set this to whatever value you want");
        overworldGenChance = cfg.getInt("overworldGenChance", CATEGORY_GENERAL, overworldGenChance, 0, 300,  "Set this to whatever value you want");
