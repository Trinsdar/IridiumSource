...
{
	private WorldGenerator ore_nether_platina, ore_end_platina, ore_overworld_platina;
	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) 
	{
		...
		{
		case -1:
			runGenerator(ore_nether_platina, world, random, chunkX, chunkZ, 5, 0, 256);
			break;
		case 0:
			runGenerator(ore_overworld_platina, world, random, chunkX, chunkZ, 5, 0, 15);
			break;
		case 1:
			runGenerator(ore_overworld_platina, world, random, chunkX, chunkZ, 5, 0, 256);
			break;
		}
	}
