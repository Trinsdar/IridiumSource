...
import lavx64.iridiumsource.objects.blocks.item.ItemBlockVariants;
import lavx64.iridiumsource.util.handlers.EnumHandler;
import lavx64.iridiumsource.util.interfaces.IHasModel;
import lavx64.iridiumsource.util.interfaces.IMetaName;
...
public class BlockOres extends Block implements IHasModel, IMetaName
{
	...
	public BlockOres(String name, String dimension)
	{
		...
		setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, EnumHandler.EnumType.PLATINA));
